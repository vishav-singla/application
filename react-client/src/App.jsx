...
const App = () => {
    ...
    const fetchMetadata = async () => {
        ...
        try {
            const response = await axios.get(`${config.API_BASE_URL}/metadata?filename=${convertedFile}`);
    ...
    const downloadFile = () => {
        if (!convertedFile) return alert('No file converted yet!');
        window.location.href = `${config.API_BASE_URL}/download?filename=${convertedFile}`;
    };
